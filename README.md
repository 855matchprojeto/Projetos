...
O microsserviço de projetos é responsável pela seguintes features:

- Criação de projeto
- Registrar interesse em um projeto
- Match de projetos se owner do projeto permitir entrada do usuário ao projeto
- Envio de mensagens SNS ao registrar interesse (para gerar notificação posteriormente)
- Envio de mensagens SNS ao permitir entrada de novo integrante (para gerar notificação posteriormente)
- Edição de projetos
- Visualização de projetos em vitrine virtual
- Demais funcionalidades vinculadas aos projetos
